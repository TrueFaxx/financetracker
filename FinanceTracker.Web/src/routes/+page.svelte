...
<div class="space-y-6">
  ...
  <div class="flex items-center justify-between">
    <div>
      ...
      <p class="mt-1 text-sm text-zinc-400">Track your finances at a glance</p>
    </div>
      ...
      <CardGlass className="border-amber-500/40 bg-gradient-to-br from-amber-500/10 to-rose-500/5">
        <div class="space-y-4">
          <div class="flex items-center gap-3">
            ...
            <div class="flex-1">
              <h2 class="text-lg font-semibold text-amber-200">⚠️ Potential Fraud Detected</h2>
              <p class="mt-1 text-sm text-amber-300/80">
                {fraud.length} purchase{fraud.length !== 1 ? "s" : ""} over $400 found this month
              </p>
            </div>
          </div>
          <div class="space-y-2">
            {#each fraud as f}
              <div class="rounded-lg border border-amber-500/20 bg-amber-500/5 p-3 transition hover:bg-amber-500/10">
                <div class="flex items-start justify-between gap-3">
                  <div class="min-w-0 flex-1">
                    ...
                    <p class="mt-1 text-xs text-amber-300/70 line-clamp-1">{f.description}</p>
                    <p class="mt-1 text-xs text-amber-400/60">{formatDate(f.date)}</p>
                  </div>
